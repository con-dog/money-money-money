// Builds dist/index.html: the same page, minified, with class/id/data names shortened. Source of truth is index.html.
...
const CLASSES = 'tagcell sortable splitopts summary sheet tabs small snapped dragging drag total red gi col off on neg pos arrow page w-amt w-conv w-del amt who w-amt2 who4 w-amt4 sh'.split(' ');
...
console.log(`index.html ${src.length} B → dist/index.html ${Buffer.byteLength(out)} B`);
