...
const CLASSES = 'tagcell sortable splitopts summary sheet tabs small snapped dragging drag total red gi col off on neg pos arrow page w-amt w-conv w-del amt who w-amt2 who4 w-amt4'.split(' ');
